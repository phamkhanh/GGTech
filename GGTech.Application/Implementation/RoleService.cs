...
namespace GGTech.Application.Implementation
{
    public class RoleService : IRoleService
    {
        ...
        {
            var functions = _functionRepository.SelectAll();
            var permissions = _permissionRepository.SelectAll();
        ...
        public void SavePermission(List<PermissionViewModel> permissionVms, Guid roleId)
        {
            ...
            var oldPermission = _permissionRepository.SelectAll().Where(x => x.RoleId == roleId).ToList();
